...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--openai_api_key",
        help="DashScope/OpenAI-compatible API key. If none given, reads DASHSCOPE_API_KEY or OPENAI_API_KEY.",
        default=None,
    )
    parser.add_argument(
        "--openai_org",
    ...
    parser.add_argument(
        "--base_url",
        help="OpenAI-compatible API base URL. Defaults to DashScope compatible-mode endpoint.",
        default=None,
    )
    parser.add_argument(
        "--llm_model",
        help="LLM model name. Defaults to HOLODECK_LLM_MODEL or qwen-max-latest.",
        default=None,
    )
    parser.add_argument(
    ...
    if args.openai_api_key is None:
        args.openai_api_key = os.environ.get("DASHSCOPE_API_KEY") or os.environ.get("OPENAI_API_KEY")
    ...
    if args.llm_model is None:
        args.llm_model = os.environ.get("HOLODECK_LLM_MODEL") or "qwen-max-latest"
