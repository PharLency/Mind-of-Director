...
from ai2holodeck.generation.qwen_llm import DashScopeLLM
...
class Holodeck:
    def __init__(
        ...
        # initialize llm
        self.llm = DashScopeLLM.from_env(
        ...
        # SBERT requires a separate HF model download. Keep it optional because
        # Objathor clip features are enough for text-to-asset retrieval smoke tests.
        self.use_sbert = use_sbert or str2bool(os.environ.get("HOLODECK_USE_SBERT", "0"))
